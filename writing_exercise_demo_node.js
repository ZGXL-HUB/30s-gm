// 书写规范填空题练习系统使用演示 - Node.js版本
// 展示如何使用系统进行练习、查看进度和统计

const { WritingExercisePracticeNode } = require('./writing_exercise_practice_node.js');

// 创建练习系统实例
const practiceSystem = new WritingExercisePracticeNode();

// 演示函数
function demonstrateSystem() {
  console.log('=== 书写规范填空题练习系统演示 (Node.js版本) ===\n');

  // 显示进度文件路径
  console.log('进度文件路径:', practiceSystem.getProgressFilePath());
  console.log('');
  ...
  // 11. 查看进度文件状态
  console.log('11. 进度文件状态:');
  const fs = require('fs');
  const progressFile = practiceSystem.getProgressFilePath();
